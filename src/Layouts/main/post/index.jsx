...
const Post = ({ post }) => {
    return (
        <div className="px-4 py-3 gap-3 border-b border-[#181818] flex ">
            <img src={post.account.avatar} alt="img" className='w-10 h-10 rounded-full object-cover' />
                ...
                <header className='leading-5 flex items-center gap-1 mb-0.5'>
                    <a href="#" className='hover:underline flex items-center font-bold'>
                        ...
                        {post.account?.verified && (
                            <svg className='text-[#1d9bf0] ml-0.5' viewBox="0 0 24 24" width={35} height={25} >
                    ...
                    <div className="text-[#9a9d9ac7] flex items-center gap-1.5">
                        <div>@{post.account.username}</div>
                        <div className='w-0.5 h-0.5 rounded-full bg-[#9a9d9ac7]' />
                        <div>17s</div>
                    </div>
                </header>
                <div>
                    ...
                    <div className="flex -ml-1.5 mt-1.5">
                        <div className="flex-1">
                            <div className="flex items-center justify-center mt-1 gap-1  rounded-full ">
                                <svg className='text-[#9a9d9ac7]  hover:text-[color:var(--color-primary)] ml-0.5' viewBox="0 0 24 24" width={20} height={20} >
                                ...
                                <span className='text-xs text-[#9a9d9ac7] flex'>{post.stats.comments}</span>
                            </div>
                        </div>
                        <div className="flex-1">
                            <div className="flex items-center justify-center mt-1 gap-1  rounded-full ">
                                ...
                                <span className='text-xs text-[#9a9d9ac7] flex'>{post.stats.repost}</span>
                            </div>
                        </div>
                        <div className="flex-1">
                            <div className="flex items-center justify-center mt-1 gap-1  rounded-full ">
                                ...
                                <span className='text-xs text-[#9a9d9ac7] flex'>{post.stats.like}</span>
                            </div>
                        </div>
                        <div className="flex-1">
                            <div className="flex items-center justify-center mt-1 gap-1  rounded-full ">
                                ...
                                <span className='text-xs text-[#9a9d9ac7] flex'>{post.stats.view}</span>
                            </div>
                        </div>
                        <div className="flex-1">
                            <div className="flex items-center justify-center mt-1 gap-1 -mr-40 rounded-full ">
                                <svg className='text-[#9a9d9ac7]  hover:text-[color:var(--color-primary)] ml-0.5' viewBox="0 0 24 24" width={20} height={20} >
                        ...
                        <div className="flex-1">
                            <div className="flex items-center justify-center mt-1 gap-1 -mr-10  rounded-full ">
                                <svg className='text-[#9a9d9ac7]  hover:text-[color:var(--color-primary)] ml-0.5' viewBox="0 0 24 24" width={20} height={20} >
